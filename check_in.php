   ...
   session_start();
	...
	$_SESSION['position'] = $row['position'];
	 ...
	 $full = "Welcome ".$fname. " " .$mname. " ".$lname. "! ". "You have successfully logged in. Enjoy your work!";
	 				...
	 				$stat = 0;
					mysql_query( "INSERT INTO time_in (username,dates,login, stat) values ('$username', curdate(),curtime(),'$stat')") or die(mysql_error());
					$msg = 
					My_Alert($full);  

		}
		else{
				$full = "Your account is not yet activated. Please contact the administrator immediately";
				$msg = 
					My_Alert($full);
...
<h1>HORROR BOOTH ATTENDANCE</h1>
     ...
     <form method="post">
		 ...
		 <p><a href="register.php">Register?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="searchpass.php">Forgot Password?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php">Home</a></p>  <a href="check_out.php">Logout</a></p>
     </form>
	 </div>
	 </div> 
</div>
